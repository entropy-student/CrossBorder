...
export default defineMiddlewares({
  routes: [
    ...
    },
    {
      ...
      methods: ["POST"],
      middlewares: [projectPublicProducts, rejectUnsafeCartCompletion],
    },
    {
    ...
    },
    {
      ...
      methods: ["POST"],
      middlewares: [projectPublicProducts, rejectTechnicalPaymentSession],
    },
    {
    ...
    },
    {
      ...
      methods: ["POST"],
      middlewares: [projectPublicProducts, rejectTechnicalShippingSelection],
    },
    {
